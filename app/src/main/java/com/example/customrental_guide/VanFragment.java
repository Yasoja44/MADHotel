...
public class VanFragment extends Fragment {
     ...
     * @return A new instance of fragment VanFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static VanFragment newInstance(String param1, String param2) {
        VanFragment fragment = new VanFragment();
    ...
    private void initImageBitmaps() {
        ...
        Query showQuery = dbRef.child("ManageRental").orderByChild("vType").equalTo("Van".trim());
        ...
        showQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot showSnapshot: dataSnapshot.getChildren()) {
                    ...
                    mImageUrls.add("https://st.depositphotos.com/1162342/1400/i/450/depositphotos_14004318-stock-photo-industrial-van.jpg");
