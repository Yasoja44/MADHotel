    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addgall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(addgall, MainActivity.GALLERY_REQUEST_CODE);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CAMERA_PERM_CODE){
            if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(MainActivity.this,"Camera Permission is Required to Use Camera",Toast.LENGTH_LONG).show();
            }
        }
    }
