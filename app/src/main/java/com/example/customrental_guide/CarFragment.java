...
public class CarFragment extends Fragment {
    ...
    private void initImageBitmaps() {
        ...
        Query showQuery = dbRef.child("ManageRental").orderByChild("vType").equalTo("Car".trim());
        ...
        showQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot showSnapshot: dataSnapshot.getChildren()) {
                    ...
                    mImageUrls.add("https://www.extremetech.com/wp-content/uploads/2019/12/SONATA-hero-option1-764A5360-edit-640x354.jpg");
