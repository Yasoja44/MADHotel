...
public class Booked_DetailsList extends ArrayAdapter<BookRoom> {
    private Activity context;
    List<BookRoom> BRoom;

    public Booked_DetailsList(Activity context, List<BookRoom> BRoom) {
        super(context, R.layout.layout_booking_details_list, BRoom);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.layout_booking_details_list, null, true);
