...
public class JanithRecyclerViewAdapter extends RecyclerView.Adapter<JanithRecyclerViewAdapter.ViewHolder>  {

    private static final String TAG = "test.sliit.recyclerview.RecyclerViewAdapter";
    private ArrayList<String> mImageNames = new ArrayList<>();
    private ArrayList<String> mImage = new ArrayList<>();
    private Context mContext;
    public JanithRecyclerViewAdapter(ArrayList<String> mImageNames, ArrayList<String>
