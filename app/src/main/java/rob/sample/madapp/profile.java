...
public class profile extends AppCompatActivity {
    ...
    android.widget.TextView name,email,phone;
    Button booking;
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        name = (android.widget.TextView)findViewById(R.id.pname);
        email =(android.widget.TextView)findViewById(R.id.pemail);
        phone = (android.widget.TextView)findViewById(R.id.pphone);
      ...
      //  button.setOnClickListener(new View.OnClickListener() {
         //   @Override
          //  public void onClick(View v) {
                ...
                booking.setOnClickListener(new android.view.View.OnClickListener() {
                    @Override
